...
export function assertHTMLElement<TKey extends keyof HTMLElementTagNameMap>(value: unknown, tag: TKey, message?: string, data?: Data): asserts value is HTMLElementTagNameMap[TKey] {
